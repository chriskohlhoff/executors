  ...
  _Func&& __f, _CompletionToken&& __token)
{
  ...
  (post_after)(__rel_time, __executor.wrap(_Traits::chain(forward<_Func>(__f),
...
{
  return (post_after)(__rel_time, __e.wrap(forward<_Func>(__f)), forward<_CompletionToken>(__token));
}
