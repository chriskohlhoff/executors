...
int main()
{
  ...
  std::future<void> fut1 = std::experimental::dispatch_at(abs_time, std::experimental::wrap(ex, function1), std::experimental::use_future);
  fut1.get();
  ...
  std::experimental::dispatch_at(abs_time, std::experimental::wrap(ex, &function1), handler3());
  std::experimental::dispatch_at(abs_time, std::experimental::wrap(ex, &function1), std::move(h3));
  std::future<void> fut2 = std::experimental::dispatch_at(abs_time, std::experimental::wrap(ex, &function1), std::experimental::use_future);
  fut2.get();
  ...
  std::future<void> fut3 = std::experimental::dispatch_at(abs_time, std::experimental::wrap(ex, function2()), std::experimental::use_future);
  fut3.get();
  ...
  std::future<void> fut4 = std::experimental::dispatch_at(abs_time, std::experimental::wrap(ex, f2), std::experimental::use_future);
  fut4.get();
  ...
  std::future<void> fut5 = std::experimental::dispatch_at(abs_time, std::experimental::wrap(ex, cf2), std::experimental::use_future);
  fut5.get();
  ...
  std::future<void> fut6 = std::experimental::dispatch_at(abs_time, std::experimental::wrap(ex, function3()), std::experimental::use_future);
  fut6.get();
  ...
  std::future<void> fut7 = std::experimental::dispatch_at(abs_time, std::experimental::wrap(ex, std::move(f3)), std::experimental::use_future);
  fut7.get();
