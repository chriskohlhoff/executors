...
int main()
{
  ...
  std::future<void> fut1 = std::experimental::post(function1, ex.wrap(std::experimental::use_future));
  fut1.get();
  ...
  std::experimental::post(&function1, ex.wrap(handler3()));
  std::experimental::post(&function1, ex.wrap(std::move(h3)));
  std::future<void> fut2 = std::experimental::post(&function1, ex.wrap(std::experimental::use_future));
  fut2.get();
  ...
  std::future<void> fut3 = std::experimental::post(function2(), ex.wrap(std::experimental::use_future));
  fut3.get();
  ...
  std::future<void> fut4 = std::experimental::post(f2, ex.wrap(std::experimental::use_future));
  fut4.get();
  ...
  std::future<void> fut5 = std::experimental::post(cf2, ex.wrap(std::experimental::use_future));
  fut5.get();
  ...
  std::future<void> fut6 = std::experimental::post(function3(), ex.wrap(std::experimental::use_future));
  fut6.get();
  ...
  std::future<void> fut7 = std::experimental::post(std::move(f3), ex.wrap(std::experimental::use_future));
  fut7.get();
