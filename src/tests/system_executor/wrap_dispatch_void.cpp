...
int main()
{
  ...
  std::future<void> fut1 = std::experimental::dispatch(function1, ex.wrap(std::experimental::use_future));
  fut1.get();
  ...
  std::experimental::dispatch(&function1, ex.wrap(handler3()));
  std::experimental::dispatch(&function1, ex.wrap(std::move(h3)));
  std::future<void> fut2 = std::experimental::dispatch(&function1, ex.wrap(std::experimental::use_future));
  fut2.get();
  ...
  std::future<void> fut3 = std::experimental::dispatch(function2(), ex.wrap(std::experimental::use_future));
  fut3.get();
  ...
  std::future<void> fut4 = std::experimental::dispatch(f2, ex.wrap(std::experimental::use_future));
  fut4.get();
  ...
  std::future<void> fut5 = std::experimental::dispatch(cf2, ex.wrap(std::experimental::use_future));
  fut5.get();
  ...
  std::future<void> fut6 = std::experimental::dispatch(function3(), ex.wrap(std::experimental::use_future));
  fut6.get();
  ...
  std::future<void> fut7 = std::experimental::dispatch(std::move(f3), ex.wrap(std::experimental::use_future));
  fut7.get();
