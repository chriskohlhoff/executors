...
int main()
{
  ...
  std::future<int> fut1 = std::experimental::dispatch_at(abs_time, function1, std::experimental::use_future);
  fut1.get();
  ...
  std::experimental::dispatch_at(abs_time, &function1, handler3());
  std::experimental::dispatch_at(abs_time, &function1, std::move(h3));
  std::future<int> fut2 = std::experimental::dispatch_at(abs_time, &function1, std::experimental::use_future);
  fut2.get();
  ...
  std::future<int> fut3 = std::experimental::dispatch_at(abs_time, function2(), std::experimental::use_future);
  fut3.get();
  ...
  std::future<int> fut4 = std::experimental::dispatch_at(abs_time, f2, std::experimental::use_future);
  fut4.get();
  ...
  std::future<int> fut5 = std::experimental::dispatch_at(abs_time, cf2, std::experimental::use_future);
  fut5.get();
  ...
  std::future<int> fut6 = std::experimental::dispatch_at(abs_time, function3(), std::experimental::use_future);
  fut6.get();
  ...
  std::future<int> fut7 = std::experimental::dispatch_at(abs_time, std::move(f3), std::experimental::use_future);
  fut7.get();
  ...
  std::future<int> fut8 = std::experimental::dispatch_at(abs_time, function_throw, std::experimental::use_future);
  try
  {
    fut8.get();
    assert(0);
  ...
  std::future<int> fut9 = std::experimental::dispatch_at(abs_time, std::experimental::package(function_throw));
  try
  {
    fut9.get();
    assert(0);
