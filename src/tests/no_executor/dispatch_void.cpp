...
int main()
{
  ...
  std::future<void> fut1 = std::experimental::dispatch(function1, std::experimental::use_future);
  fut1.get();
  ...
  std::experimental::dispatch(&function1, handler3());
  std::experimental::dispatch(&function1, std::move(h3));
  std::future<void> fut2 = std::experimental::dispatch(&function1, std::experimental::use_future);
  fut2.get();
  ...
  std::future<void> fut3 = std::experimental::dispatch(function2(), std::experimental::use_future);
  fut3.get();
  ...
  std::future<void> fut4 = std::experimental::dispatch(f2, std::experimental::use_future);
  fut4.get();
  ...
  std::future<void> fut5 = std::experimental::dispatch(cf2, std::experimental::use_future);
  fut5.get();
  ...
  std::future<void> fut6 = std::experimental::dispatch(function3(), std::experimental::use_future);
  fut6.get();
  ...
  std::future<void> fut7 = std::experimental::dispatch(std::move(f3), std::experimental::use_future);
  fut7.get();

  assert(function_count == 63);
  assert(handler_count == 49);

  std::future<void> fut8 = std::experimental::dispatch(function_throw, std::experimental::use_future);
  try
  {
    fut8.get();
    assert(0);
  ...
  std::future<void> fut9 = std::experimental::dispatch(std::experimental::package(function_throw));
  try
  {
    fut9.get();
    assert(0);
