...
int main()
{
  ...
  std::future<int> fut1 = std::experimental::post(function1, ex, std::experimental::use_future);
  fut1.get();
  ...
  std::experimental::post(&function1, ex, handler3());
  std::experimental::post(&function1, ex, std::move(h3));
  std::future<int> fut2 = std::experimental::post(&function1, ex, std::experimental::use_future);
  fut2.get();
  ...
  std::future<int> fut3 = std::experimental::post(function2(), ex, std::experimental::use_future);
  fut3.get();
  ...
  std::future<int> fut4 = std::experimental::post(f2, ex, std::experimental::use_future);
  fut4.get();
  ...
  std::future<int> fut5 = std::experimental::post(cf2, ex, std::experimental::use_future);
  fut5.get();
  ...
  std::future<int> fut6 = std::experimental::post(function3(), ex, std::experimental::use_future);
  fut6.get();
  ...
  std::future<int> fut7 = std::experimental::post(std::move(f3), ex, std::experimental::use_future);
  fut7.get();
