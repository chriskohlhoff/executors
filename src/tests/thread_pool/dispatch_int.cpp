...
int main()
{
  ...
  std::future<int> fut1 = std::experimental::dispatch(pool, function1, std::experimental::use_future);
  fut1.get();
  ...
  std::experimental::dispatch(pool, &function1, handler3());
  std::experimental::dispatch(pool, &function1, std::move(h3));
  std::future<int> fut2 = std::experimental::dispatch(pool, &function1, std::experimental::use_future);
  fut2.get();
  ...
  std::future<int> fut3 = std::experimental::dispatch(pool, function2(), std::experimental::use_future);
  fut3.get();
  ...
  std::future<int> fut4 = std::experimental::dispatch(pool, f2, std::experimental::use_future);
  fut4.get();
  ...
  std::future<int> fut5 = std::experimental::dispatch(pool, cf2, std::experimental::use_future);
  fut5.get();
  ...
  std::future<int> fut6 = std::experimental::dispatch(pool, function3(), std::experimental::use_future);
  fut6.get();
  ...
  std::future<int> fut7 = std::experimental::dispatch(pool, std::move(f3), std::experimental::use_future);
  fut7.get();
